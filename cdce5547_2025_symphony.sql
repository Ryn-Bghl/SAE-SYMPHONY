...
--
-- Hôte : localhost
-- Généré le : lun. 09 juin 2025 à 17:10
...
(5, 'Blue\'s & Berry', 'Myrtille', 4.50, 'Rn\'b', 'Avec Blue’s & Berry, Symphony signe une bière où le groove rencontre la gourmandise.\nImagine un solo de piano dans une cave enfumée, une myrtille juteuse entre les doigts.', 'Honey Salt'),
...
(1, 'doe', 'john', 'john.doe@gmail.com', '$2y$10$ewei8LehSVw.v7Gt52q4FOu/1KpBfwSCbEm.66zr0DOe3ShOUhIqi'),
(2, 'rayan', 'boughalia', 'boughalia.rayan@gmail.com', '$2y$10$fsPhrIh0uOjwN0wnxJet5eT2FMbCmfE165eftfK/lYO1V4tn47avW');
